...
echo "  ${GR}    ==[ Tools Name : Audio Manager Cracker"
echo "  ${GR}    ==[ Coded by : Yell Phone Naing"
echo "   ${ORANGE} ==[ Version : 1.0.0"
echo "  ${PURPLE}  ==[ Program Type :Bash"
# Select Target
...
echo "${RED} NOW GO TO FILEMANAGER AND OPEN "
echo "${YO}Cracked Folder,YOU WILL SEE THE CRACKED VIDEOS FILES "
